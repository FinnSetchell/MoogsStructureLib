...
public class MoogsStructuresNeoforge {
    ...
    public MoogsStructuresNeoforge(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modEventBus.addListener(com.finndog.moogs_structures.neoforge.MoogsStructuresNeoforge::onSetup);

        IEventBus eventBus = NeoForge.EVENT_BUS;
        eventBus.addListener(com.finndog.moogs_structures.neoforge.MoogsStructuresNeoforge::onServerStarting);
        eventBus.addListener(com.finndog.moogs_structures.neoforge.MoogsStructuresNeoforge::onServerStopping);
        eventBus.addListener(com.finndog.moogs_structures.neoforge.MoogsStructuresNeoforge::onAddReloadListeners);
    }
