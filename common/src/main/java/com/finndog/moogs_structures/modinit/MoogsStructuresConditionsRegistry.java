...
public final class MoogsStructuresConditionsRegistry {
     ...
     * Identifier of the condition you registered. The msl_pieces_spawn_counts folder files can also take
     ...
     * FABRIC/QUILT:
         BuiltInRegistries.REGISTRY.getOptional(new Identifier("repurposed_structures", "json_conditions"))
             .ifPresent(registry -> Registry.register(
                 (Registry<Supplier<Boolean>>)registry,
                 new Identifier("repurposed_structures", "test"),
     ...
     * FORGE:
        public static final DeferredRegister<Supplier<Boolean>> RS_CONDITIONS_REGISTRY = DeferredRegister.createOptional(
                new Identifier("repurposed_structures", "json_conditions"), "modid");
