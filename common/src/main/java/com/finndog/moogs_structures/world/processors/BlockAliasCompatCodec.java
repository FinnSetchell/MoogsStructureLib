 ...
 * unchanged — so the same MSL jar works on both sides of a rename boundary (e.g. the
 * {@code 1.21.5-1.21.10} branch covers MC versions before and after the chain rename).
 *
