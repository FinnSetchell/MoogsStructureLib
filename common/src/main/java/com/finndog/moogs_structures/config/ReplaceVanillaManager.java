...
public final class ReplaceVanillaManager {
    ...
    private static final Map<ResourceLocation, Replacement> BY_VANILLA_STRUCTURE = new HashMap<>();
    ...
    public static void init() {
        ...
        Map<String, String> manifests = PlatformConfig.getOptionalPackManifests();
    ...
    private static void parseManifest(String modid, String json) {
        ...
        for (JsonElement presetEl : root.getAsJsonArray("presets")) {
            ...
            for (JsonElement el : preset.getAsJsonArray("replacements")) {
                ...
                ResourceLocation vanillaStructure = obj.has("vanilla_structure") ? ResourceLocation.tryParse(obj.get("vanilla_structure").getAsString()) : null;
                ResourceLocation replacementStructure = obj.has("replacement_structure") ? ResourceLocation.tryParse(obj.get("replacement_structure").getAsString()) : null;
