...
public class StructureActionsEntry extends TooltipListEntry<Object> {
    ...
    // model - extractRenderState(GuiGraphicsExtractor, ...). Text draws via GuiGraphicsExtractor.text(...)
    // (replacing GuiGraphics.drawString), and child widgets register their own state via extractRenderState.
    @Override
